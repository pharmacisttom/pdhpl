...
$category_name = 'Health Economy Excellence';
...
<head>
    ...
    <title>Health Economy Excellence - ระบบบริหารจัดการ KPI 2569</title>
    ...
    <style>
        ...
        .kpi-card { border-left: 4px solid #6f42c1; transition: all 0.2s; }
...
<body class="d-flex">
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4 bg-white p-3 rounded shadow-sm border-start border-purple border-4" style="border-left-color: #6f42c1 !important;">
            <h4 class="mb-0 text-secondary fw-bold"><i class="fa-solid fa-coins text-purple me-2" style="color: #6f42c1;"></i> Health Economy Excellence (ด้านเศรษฐกิจสุขภาพ)</h4>
            <div><span class="badge fs-6 px-3 py-2" style="background-color: #6f42c1;">ปีงบประมาณ 2569</span></div>
        </div>

        <div class="row" id="kpi-list">
            <?php foreach ($kpis as $kpi): ?>
            <div class="col-md-12 mb-3">
                <div class="card kpi-card shadow-sm border-0" style="border-left-color: #6f42c1;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="fw-bold mb-1" style="color: #6f42c1;">ตัวชี้วัดที่ <?php echo htmlspecialchars($kpi['kpi_number'] . '. ' . $kpi['kpi_name']); ?></h5>
