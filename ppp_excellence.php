...
<head>
    ...
    <title>PP&P Excellence - ระบบบริหารจัดการ KPI 2569</title>
    ...
    <style>
        ...
        .kpi-card { border-left: 4px solid #0d6efd; transition: all 0.2s; }
...
<body class="d-flex">
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4 bg-white p-3 rounded shadow-sm border-start border-primary border-4">
            <h4 class="mb-0 text-secondary fw-bold"><i class="fa-solid fa-shield-halved text-primary me-2"></i> PP&P Excellence (ด้านส่งเสริมสุขภาพฯ)</h4>
            <div><span class="badge bg-primary fs-6 px-3 py-2">ปีงบประมาณ 2569</span></div>
        </div>
                ...
                <div class="card kpi-card shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="text-primary fw-bold mb-1">ตัวชี้วัดที่ <?php echo htmlspecialchars($kpi['kpi_number'] . '. ' . $kpi['kpi_name']); ?></h5>
