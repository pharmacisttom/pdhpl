...
$category_name = 'Governance Excellence';
...
<head>
    ...
    <title>Governance Excellence - ระบบบริหารจัดการ KPI 2569</title>
    ...
    <style>
        ...
        .kpi-card { border-left: 4px solid #dc3545; transition: all 0.2s; }
...
<body class="d-flex">
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4 bg-white p-3 rounded shadow-sm border-start border-danger border-4">
            <h4 class="mb-0 text-secondary fw-bold"><i class="fa-solid fa-scale-balanced text-danger me-2"></i> Governance Excellence (ด้านบริหารเป็นเลิศ)</h4>
            <div><span class="badge bg-danger fs-6 px-3 py-2">ปีงบประมาณ 2569</span></div>
        </div>
                ...
                <div class="card kpi-card shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="text-danger fw-bold mb-1">ตัวชี้วัดที่ <?php echo htmlspecialchars($kpi['kpi_number'] . '. ' . $kpi['kpi_name']); ?></h5>
